...
func (rt *_router) Handler() http.Handler {
	...
	rt.router.PUT("/users/:userID/follow/:username", rt.follow)
	rt.router.DELETE("/users/:userID/unfollow/:username", rt.unfollow)
	rt.router.PUT("/users/:userID/block/:username", rt.block)
	rt.router.DELETE("/users/:userID/unblock/:username", rt.unblock)
	rt.router.GET("/users/:userID/followers", rt.getFollowers)
	rt.router.DELETE("/users/:userID/followers/:username/remove", rt.rmFollower)
